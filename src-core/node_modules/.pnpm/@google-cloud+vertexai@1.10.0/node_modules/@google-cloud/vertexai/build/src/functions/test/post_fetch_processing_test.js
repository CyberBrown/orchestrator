...
describe('aggregateResponses', () => {
    ...
    it('should aggregate text and functionCalls to separate parts', () => {
        const actualResult = (0, post_fetch_processing_1.aggregateResponses)(test_data_1.STREAM_RESPONSE_CHUNKS_5);
        expect(JSON.stringify(actualResult)).toEqual(JSON.stringify(test_data_1.AGGREGATED_RESPONSE_STREAM_RESPONSE_CHUNKS_5));
    });
    it('should aggregate functionCalls with the empty text removed', () => {
        const actualResult = (0, post_fetch_processing_1.aggregateResponses)(test_data_1.STREAM_RESPONSE_CHUNKS_6);
        expect(JSON.stringify(actualResult)).toEqual(JSON.stringify(test_data_1.AGGREGATED_RESPONSE_STREAM_RESPONSE_CHUNKS_6));
    });
});
