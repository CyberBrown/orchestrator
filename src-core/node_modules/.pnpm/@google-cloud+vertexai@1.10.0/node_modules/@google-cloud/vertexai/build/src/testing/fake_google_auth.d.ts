...
export declare class FakeGoogleAuth extends GoogleAuth {
    private readonly params;
    constructor(params: FakeGoogleAuthParams);
    getAccessToken(): Promise<string | null | undefined>;
}
/** Creates a fake GoogleAuth for testing. */
export declare function createFakeGoogleAuth(params?: FakeGoogleAuthParams): GoogleAuth;
export {};
