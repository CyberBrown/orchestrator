...
export declare type EIP1193EventMap = {
...
export declare type EIP1193Events = {
    on<event extends keyof EIP1193EventMap>(event: event, listener: EIP1193EventMap[event]): void;
    removeListener<event extends keyof EIP1193EventMap>(event: event, listener: EIP1193EventMap[event]): void;
};
export declare type EIP1193RequestFn = (args: {
    method: string;
    params?: unknown;
}) => Promise<unknown>;
export declare type EIP1193Provider = EIP1193Events & {
    address: string;
 ...
 */
export declare type SiweMessage = {
    /**
...
export declare type EthereumSignInInput = SiweMessage;
